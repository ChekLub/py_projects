...
Решено в pandas, визуализация matplotlib: гистограммы (bins), круговые диаграммы с детализацией сектора (pie_bar), точечное распредление (scatter), столбчатые диаграммы (bar).
