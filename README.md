...
Решено в pandas, визуализация matplotlib: гистограммы (bins), круговые диаграммы с детализацией сектора (pie), график рассеяния (scatter), столбчатые диаграммы (bar).
